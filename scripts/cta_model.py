...
CTA_AUM_SCALAR: Dict[str, float] = {
    ...
    "us10y":   50_000_000_000,   # ~$50B; rates are the largest CTA market
    "gold":    12_000_000_000,   # ~$12B; gold is a major CTA allocation
    "wti":      8_000_000_000,   # ~$8B
    "bitcoin":  3_000_000_000,   # ~$3B; growing but still small vs traditional assets
    "eurfx":    5_000_000_000,   # ~$5B
    "gbpfx":    3_000_000_000,   # ~$3B
    "dxy":      4_000_000_000,   # ~$4B
    "corn":     2_000_000_000,   # ~$2B
    "vix":      1_500_000_000,   # ~$1.5B; CTAs are structurally short vol premia
}
